# This code is taken from https://github.com/dasirra/latent-class-analysis
# I've lowered the default for 'tol' and increased the default for 'max_iter'.
...
class LCA:
    def __init__(self, n_components=2, tol=1e-4, max_iter=1000, random_state=None):
